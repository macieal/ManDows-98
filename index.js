...
function error33123antivarios() {
  ...
  setTimeout(() => {
    ...
    document.getElementById("updatebutton33123antivarios").style.display =
      "block";
  }, 10000);
}
...
function antivariosjabrirunlocker() {
  document.getElementById("loading-antivarios-unlocked").style.display =
    "block";
  setTimeout(() => {
    document.getElementById("loadingantivarios-success").style.display =
      "block";
...
function antivariosjabrirboras() {
  ...
  if (iframeJogo) {
    ...
    setTimeout(() => {
      iframeJogo.contentWindow.postMessage(
        { action: "message", elementId: "antivariosiniciargame" },
        "*",
      );
    }, 100);
  }
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                document.getElementById("Terminal-Iframe").src =
                  "term-fix-game/bug-fix-game-term.html";
                document.getElementById("exitbuttonterm").style.pointerEvents =
                  "none";
                setTimeout(() => {
                  document.getElementById("TerminalJ").style.display = "none";
                  setTimeout(() => {
...
function blockedsystemusedupdate() {
  ...
  document.getElementById("BakExplorerCloseButton").style.pointerEvents =
    "none";
}
